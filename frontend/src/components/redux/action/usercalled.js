...
export const loginUser = ({email, password}) => async (dispatch) => {
    try {
        ...
        const {data} = await axios.post('https://backend-0xvl.onrender.com/api/v1/auth/login',{email,password}, {headers:{
...
export const registerUser = ( {email,password,name,avatar}) => async (dispatch) => {
    try {
        ...
        dispatch({type:registerRequest})
            const {data} = await axios.post('https://backend-0xvl.onrender.com/api/v1/auth/register',{name,email,password,avatar}, {headers:{
                'Content-Type': 'application/json',
                },
                withCredentials: true,
            })
...
export const logoutUser = () => async (dispatch) => {
    try {
      await axios.get(`https://backend-0xvl.onrender.com/api/v1/auth/logout`,{withCredentials: true});
...
export const loadUser = () => async (dispatch) => {
    try {
      ...
      const  {data}  = await axios.get(`https://backend-0xvl.onrender.com/api/v1/auth/me`, config);
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.put(`https://backend-0xvl.onrender.com/api/v1/auth/me/update`, userData, config);
  ...
  export const updatePassword = (passwords) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.put(`https://backend-0xvl.onrender.com/api/v1/auth/change-password`, passwords, config);
  ...
  export const forgotPassword = ({email}) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`https://backend-0xvl.onrender.com/api/v1/auth/password/forget`, {email}, config);
  ...
  export const resetPassword = (token, passwords) => async (dispatch) => {
    try {
      ...
      const config = { headers: { "Content-Type": "application/json" } };
      const { data } = await axios.put(`https://backend-0xvl.onrender.com/api/v1/auth/password/reset/${token}`, passwords, config);
  ...
  export const getAllUsers = () => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`https://backend-0xvl.onrender.com/api/v1/auth/admin/users`,config);
  ...
  export const getUserDetails = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`https://backend-0xvl.onrender.com/api/v1/auth/admin/user/${id}`,config);
  ...
  export const updateUser = (id, userData) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.put(
        `https://backend-0xvl.onrender.com/api/v1/auth/admin/user/${id}`,
        userData,
        config
      );
      console.log(data)
  ...
  export const deleteUser = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.delete(`https://backend-0xvl.onrender.com/api/v1/auth/admin/user/${id}`,config);
